...
public class ServerManager {
    ...
    private final Queue<ClientActor> clientActorQueue;
    ...
    public void printClientQueue(){
        ...
        for(ClientActor client: clientActorQueue){
                System.out.println(client.toString());
        }
    }

    public void addClientToQueue(ClientActor client){
        clientActorQueue.add(client);
    }
}

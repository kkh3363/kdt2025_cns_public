...
public class ClientView extends JFrame {
    ...
    public ClientView()   {
        ...
        btnConnect.setBounds(530, 395, 109, 35);
        contentPane.add(btnConnect);

        btnDisConnect = new JButton("연결종료");
        btnDisConnect.setFont(new Font("HY견고딕", Font.BOLD, 14));
        btnDisConnect.setBounds(640, 395, 109, 35);
        ...
        btnDisConnect.addActionListener(new ClientActionHandler(this));
        setVisible(true);
                    ...
                    while(true){
                        ...
                        try {
                            ...
                            try {
                                ...
                                pw.close();
                                socket.close();
                                appendLog("서버와 접속이 끊어짐");
                                //JOptionPane.showMessageDialog(null, "서버와 접속이 끊어짐",
